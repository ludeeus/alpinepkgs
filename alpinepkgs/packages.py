...
class Packages(object):
    """A class for the alpinepkgs API."""

    def __init__(self, package=None, branch=BRANCHES[-2]):
    ...
    def get_package(self):
        ...
        url = BASE_URL.format(self._package, self._branch)

        data = {'package': self._package, 'branch': self._branch}
